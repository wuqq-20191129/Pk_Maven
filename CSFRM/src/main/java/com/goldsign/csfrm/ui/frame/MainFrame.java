...
public class MainFrame extends JFrame implements java.awt.event.ActionListener{
    ...
    private void initComponents() {
        ...
        mainMenuPanel = new ImagePanel(new ImageIcon(BaseConstant.appWorkDir+"/src/main/resources/images/up_background.jpg").getImage());
        welcomeLabel = new JLabel();
        welcomeLongLabel = new JLabel();
        opStatusPanel = new ImagePanel(new ImageIcon(BaseConstant.appWorkDir+"/src/main/resources/images/down_background.jpg").getImage());
        subMenuPanel = new ImagePanel(new ImageIcon(BaseConstant.appWorkDir+"/src/main/resources/images/left_menu.jpg").getImage());
        workScrollPane = new JScrollPane();
        workPanel = new JPanel();

        setDefaultCloseOperation(WindowConstants.EXIT_ON_CLOSE);
        setUndecorated(true);

        logoPanel.setBackground(new Color(204, 255, 255));
        ...
        mainMenuPanel.setBackground(new Color(0, 153, 204));

        welcomeLabel.setFont(new Font("宋体", 1, 14)); // NOI18N
        welcomeLabel.setForeground(Color.white);
        welcomeLabel.setHorizontalAlignment(SwingConstants.CENTER);

        welcomeLongLabel.setFont(new Font("宋体", 1, 14)); // NOI18N
        welcomeLongLabel.setForeground(new Color(255, 255, 255));
        welcomeLongLabel.setHorizontalAlignment(SwingConstants.CENTER);
        ...
        opStatusPanel.setBackground(new Color(255, 255, 255));
        ...
        subMenuPanel.setBackground(new Color(102, 153, 255));
        ...
        workPanel.setBackground(new Color(237, 247, 249));
    ...
    private void addLogo(){
        ...
        ImageIcon icon = new ImageIcon(BaseConstant.appWorkDir+"/src/main/resources/images/logo.jpg");
        int  width =0;
        int  height =0;
    ...
    private void genStatusBar(){
        ...
        for(int i=0; i<partLen; i++){
            ...
            part1Ws[i] = this.getPreferredWidthForLabel(jl,partLabelText, new Font("宋体", 1, 14));
        ...
        String tipMsg = "  提示信息:";
        int part11W = this.getPreferredWidthForLabel(jl,tipMsg,new Font("宋体", 1, 14));
        ...
        this.statusOpResultLable = this.addLabel("opResultLabel",tipMsg,this.opStatusPanel,x,y1,0,height,JLabel.LEFT_ALIGNMENT,
                null, new Font("宋体", 1, 14),new Color(0,0,0));
        x+=part11W;
        this.statusOpResult = this.addLabel("statusOpResult","",this.opStatusPanel,x,y1,screenW-part11W-3,height,JLabel.LEFT_ALIGNMENT, border,
                new Font("宋体", 0, 14),new Color(70,95,125));
        //保存状态结果栏
    ...
    private JButton addButton(String name,String text,Container c,int x,int y,
        ...
        if(menu_icon!=null&&menu_icon.trim().length()>0){
            ...
            if(menu_icon.trim().length()==2||"shift".equals(menu_icon.trim())){
                f = new File(BaseConstant.appWorkDir+"/src/main/resources/images/menu/"+"main_icon"+".png");
                sf = new File(BaseConstant.appWorkDir+"/src/main/resources/images/menu/"+"selected_main_icon"+".png");
                if(f.exists()){
                    icon_name = "main_icon";
                ...
                f = new File(BaseConstant.appWorkDir+"/src/main/resources/images/menu/"+"sub_icon"+".png");
                sf = new File(BaseConstant.appWorkDir+"/src/main/resources/images/menu/"+"selected_sub_icon"+".png");
                if(f.exists()){
                    icon_name = "sub_icon";
                    ImageIcon icon = setButtonIcon(icon_name, width, height);
                    button.setIcon(icon);
    ...
    */
    private ImageIcon setButtonIconSelected(String icon_name, int width,int height){
        ImageIcon selectedIcon = new ImageIcon(BaseConstant.appWorkDir+"/src/main/resources/images/menu/"+icon_name+".png");
...
//  modify by lijia 2017/11/28
    ...
    private JPanel opStatusPanel;
    private JPanel subMenuPanel;
    private JLabel welcomeLabel;
    private JLabel welcomeLongLabel;
