...
public class DateHelper {
     ...
     * @return 
     */
    public static String getSecond(Date d) {
     ...
     * @return 
     */
    public static String dateToStr14yyyyMMddHHmmss(Date d) {
        SimpleDateFormat f = new SimpleDateFormat("yyyyMMddHHmmss");
        return f.format(d);
    }
     ...
     * @return
     */
    public static String dateToStr15yyyyMMdd_HHmmss(Date d) {
     ...
     * @return 
     */
    public static String dateToStr8yyyyMMdd(Date d) {
     ...
     * @return 
     */
    public static String dateToStr6yyMMdd(Date d) {
     ...
     * @return 
     */
    public static String dateToStr8yyyy_MM_dd(Date d) {
        SimpleDateFormat f = new SimpleDateFormat("yyyy-MM-dd");
        return f.format(d);
    }
     ...
     * @return 
     */
    public static String dateToStr19yyyy_MM_dd_HH_mm_ss(Date d) {
        SimpleDateFormat f = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
        return f.format(d);
    }
    ...
    public static String curDateToStr8yyyyMMdd() {
        return DateHelper.dateToStr8yyyyMMdd(new Date());
    }
