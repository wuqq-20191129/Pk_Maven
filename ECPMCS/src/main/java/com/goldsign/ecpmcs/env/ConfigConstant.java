...
public class ConfigConstant extends AppConstant{
    ...
    //配置和日志文件
    public static final String CONFIG_FILE = appWorkDir+"/src/main/resources/"+"config/CommonConfig.xml";     //配置文件
    public static final String LOG_FILE = appWorkDir+"/src/main/resources/"+"config/Log4jConfig.xml";        //日志文件
    public static final String P_ERROR_FILE = appWorkDir+"/src/main/resources/"+"config/PrintErrorCode.txt";        //打印机错误代码文件
    public static final String PRINT_TEMPLATE_PATH = appWorkDir+"/src/main/resources/"+"template/templateTxt/";        //打印模板文件路径
    public static final String PRINT_BACKGROUND_PIC_PATH =appWorkDir+"/src/main/resources/"+ "template/templatePics/";        //打印模板正反面背景图片路径
