...
public class ConfigConstant extends AppConstant{
    ...
    //配置和日志文件
   // public static String CONFIG_FILE = appWorkDir+"/src/main/resources/"+"config/CommonConfig_zhukong.xml";     //配置文件
    public static String CONFIG_FILE = appWorkDir+"/src/main/resources/"+"config/CommonConfig.xml";     //配置文件

    public static String LOG_FILE = appWorkDir+"/src/main/resources/"+"config/Log4jConfig.xml";        //日志文件
