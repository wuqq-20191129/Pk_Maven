...
public class MadeCardPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jPanel2.setBackground(new Color(237, 247, 249));
        ...
        employeeIdQry.setForeground(new Color(0, 39, 80));
        ...
        jTextField4.setBackground(new Color(185, 227, 241));
        jTextField4.setFont(new java.awt.Font("宋体", 1, 16)); // NOI18N
        jTextField4.setForeground(new Color(94, 55, 16));
        ...
        employeeNameQry.setForeground(new Color(0, 39, 80));
        ...
        jLabel5.setForeground(new Color(0, 39, 80));
        ...
        jPanel3.setBackground(new Color(237, 247, 249));
        jPanel3.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        jPanel3.setForeground(new Color(70, 95, 125));

        jLabel3.setFont(new java.awt.Font("宋体", 1, 16)); // NOI18N
        jLabel3.setForeground(new Color(0, 39, 80));
        ...
        employeeNameTxt.setForeground(new Color(0, 39, 80));
        ...
        jLabel9.setForeground(new Color(0, 39, 80));
        jLabel9.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel9.setText("工号：");

        jTextField6.setEditable(false);
        jTextField6.setBackground(new Color(185, 227, 241));
        jTextField6.setDocument(new LengthLimitDocument(15));
        jTextField6.setFont(new java.awt.Font("宋体", 1, 16)); // NOI18N
        jTextField6.setForeground(new Color(94, 55, 16));
        ...
        jLabel6.setForeground(new Color(0, 39, 80));
        jLabel6.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel6.setText("性别：");

        genderCB.setFont(new java.awt.Font("宋体", 0, 16)); // NOI18N
        genderCB.setForeground(new Color(0, 39, 80));
        ...
        employeeDepartment.setBackground(new Color(240, 240, 240));
        employeeDepartment.setEditable(true);
        employeeDepartment.setFont(new java.awt.Font("宋体", 0, 16)); // NOI18N
        employeeDepartment.setForeground(new Color(0, 39, 80));
        ...
        jLabel7.setForeground(new Color(0, 39, 80));
        ...
        employeePosition.setForeground(new Color(0, 39, 80));
        ...
        jLabel1.setForeground(new Color(0, 39, 80));
        jLabel1.setText("员工级别：");

        employeeClass.setBackground(new Color(240, 240, 240));
        employeeClass.setEditable(true);
        employeeClass.setFont(new java.awt.Font("宋体", 0, 16)); // NOI18N
        employeeClass.setForeground(new Color(0, 39, 80));
        ...
        btCancel.setForeground(new Color(0, 39, 80));
        btCancel.setText("取消");
        ...
        btWriteCard.setForeground(new Color(0, 39, 80));
        ...
        jLabelMadeInfo01.setForeground(new Color(70, 95, 125));
        ...
        jLabelMadeInfo02.setForeground(new Color(255, 93, 2));
        ...
        jLabelMadeInfo03.setForeground(new Color(70, 95, 125));

        jLabelMadeInfo04.setFont(new java.awt.Font("宋体", 1, 14)); // NOI18N
        jLabelMadeInfo04.setForeground(new Color(255, 93, 2));
        ...
        jLabelMadeInfo05.setForeground(new Color(70, 95, 125));
        jLabelMadeInfo05.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);

        isBeeCB.setBackground(new Color(254, 254, 254));
        isBeeCB.setFont(new java.awt.Font("宋体", 1, 14)); // NOI18N
        isBeeCB.setForeground(new Color(0, 39, 80));
        ...
        btConfirm.setForeground(new Color(0, 39, 80));
    ...
    private void setVoDepartment(MakeCardVo makeCardVo) {
        if(employeeDepartment.getEditor().getItem() != null){
            ...
            if(employeeDepartment.getItemCount() > 0){
                if(!(employeeDepartment.getSelectedItem() instanceof String)){
    ...
    private void setVoClass(MakeCardVo makeCardVo) {
        if(employeeClass.getEditor().getItem() != null){
            ...
            if(employeeClass.getItemCount() > 0){
                if(!(employeeClass.getSelectedItem() instanceof String)){
    ...
    private void setVoPosition(MakeCardVo makeCardVo) {
        if(employeePosition.getEditor().getItem() != null){
            ...
            if(employeePosition.getItemCount() > 0){
                if(!(employeePosition.getSelectedItem() instanceof String)){
